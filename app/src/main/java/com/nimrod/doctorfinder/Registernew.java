...
import com.nimrod.utils.CommonUtilities;
import com.nimrod.utils.WakeLocker;
import com.nimrod.utils.logingetset;
    ...
    public class getlogin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (status.equals("Success")) {
                ...
                Toast.makeText(Registernew.this, "Error occurred while creating account!!", Toast.LENGTH_LONG).show();
            }
        }

...
//                });
        ...
        TextView txt_map=findViewById(R.id.txt_map);
        txt_map.setTypeface(TF_ralewayMidium);
//        txt_map.setText("Doctor Map View");
...
//        actionBar.setBackgroundDrawable(drawable);
    ...
    private void drawer() {
        ...
        LinearLayout ll_homen = findViewById(R.id.ll_home);
        ll_homen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iv = new Intent(Home.this, MapsActivity.class);
                startActivity(iv);
            }
        });
